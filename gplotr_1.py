...
neuron_file_loc = '/home/ram/neural_prj/outputs/gp_opt/'+dataname+'F' #SRIRAM01302018
#Change directory so that outcmaes*.dat will be saved to different directories
if not os.path.exists(neuron_file_loc):  #SRIRAM01302018
     os.mkdir(neuron_file_loc)           #SRIRAM01302018

os.chdir(neuron_file_loc)                #SRIRAM01302018

print("gpe data keys:", gpe.data.keys()) #SRIRAM1302018
# Could not find key "proto79-2s" cause gpe.data has 'nr047', 'nr120', 'nr144', 'nr140' #SRIRAM01302018
...
# Use the save command and make note that should be fixed in future. #SRIRAM02012018
#exec(open("/home/ram/neural_prj/run_scripts/prof_resources/save_params.py").read()) #SRIRAM02012018
...
#save_params(fit1, startgood, threshold) #SRIRAM02012018
...
os.chdir('/home/avrama/moose/gp_opt/'+dataname+'F')
...
startgood=1500
threshold=0.34 #median = 0.34 after 250 generations (Jan 16)
